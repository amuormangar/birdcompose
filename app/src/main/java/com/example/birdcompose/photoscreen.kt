...
@Composable
fun photoScreen(birdName:String,imageId:Int,screenNumber:Int,navController:NavController){
...
fun photoScreenPreview(){
    photoScreen(birdName = "Owl",R.drawable.owl, screenNumber = 1, rememberNavController())
}
